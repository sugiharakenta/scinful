...
************************************************************************
*                                                                      *
      subroutine packqmd(massal,msprgr)
*                                                                      *
*                                                                      *
*        Last Revised:     1998 11 27                                  *
*                                                                      *
...
*-----------------------------------------------------------------------
               ...
               ebini  = - bndeng( msprgr, massal - msprgr )
     &                / float( massal )
               ebin00 =   ebini * 0.001
...
*-----------------------------------------------------------------------
   ...
   32       continue
                  ...
                  write(ieo,'(/
     &                '' **** Fault in Adjust Ground Energy ****'')')
                  write(ieo,'(
     &                ''      Edif = '',e13.4,'' MeV'')') edif*1000.0
