...
*-----------------------------------------------------------------------
     ...
     &                inun(nnn), iavd(nnn), ihis(nnn)
      ...
      common / flag / iflag        ! added by satoh on 26/08/2000
...
*======================================================================*
            ...
            ichannel = 0
c_next one line is added by satoh (26/08/2000)
                 if( iflag .eq. 0) goto 1072
...
*-----------------------------------------------------------------------
         ...
         if( rn() .lt. 0.5 ) then
            ...
            if( asrtn .gt. 0.0 ) then
               ...
               ta  = -2.0 * prad**2
               x   = rn()
               t1  = alog( (1-x) * exp( max(-50.0,2.*a*ta) ) + x ) / a
               c1  = 1.0 - t1/ta
               if(abs(c1).gt.1.0) c1 = 2.0 * x - 1.0
...
*-----------------------------------------------------------------------
            ...
            if( dt .le. dtmax .and. rn() .lt. w )  goto 800
...
*-----------------------------------------------------------------------
*        Summary for the above final pion decays
*-----------------------------------------------------------------------
...
*-----------------------------------------------------------------------
  ...
  200       idem = idem + 1
            ...
            dem1 = dem10 + ( srt - dem10 - dem20 ) * rn()
            dem2 = dem20 + ( srt - dem1  - dem20 ) * rn() * isdm(isd2)
